import { TreeView, TreeItem, treeViewTemplate, treeItemTemplate } from "@microsoft/fast-foundation";
import { treeViewStyles, treeItemStyles } from "@microsoft/fast-components";
import { css } from "@microsoft/fast-element";

export const treeView = TreeView.compose({
    baseName: "tree-view",
...
export const treeItem = TreeItem.compose({
    baseName: "tree-item",
    template: treeItemTemplate as any,
    expandCollapseGlyph: `
